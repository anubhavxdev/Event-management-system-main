              ...
              <div className="space-y-6">
                {upcomingEvents.length === 0 ? (
                  ...
                  >
                    ...
                    <Button asChild className="mt-6 bg-rose-600 hover:bg-rose-700 text-white">
                            ...
                            <div className="flex justify-between pt-4 md:pt-0 gap-2">
                              {reg.status === 'cancelled' ? (
                                reg.refundStatus === "pending" ? (
                                  ...
                                  <p className='text-sm text-green-500 font-bold'>Amount Refunded of ₹{reg.refundAmount}</p>
                                ) : null
                              ) : (
                                <>
                                  <Button
