...
export default function GradientHero() {
  ...
  // Dynamic animated placeholders interval
  useEffect(() => {
  ...
  // RIGHT SIDE SEARCH BUTTON TRIGGER FUNCTION (FIXED)
  const handleSearchSubmit = (e) => {
    ...
    // /events ki jagah home route par hi query push karega taaki 404 break na ho
...
>>>>>>> main
          ...
          >
            ...
            plan, manage, and host impactful events with ease. Trusted by GDG
            Jalandhar, AWS Cloud Clubs, and Coding Ninjas.
          </motion.p>
          ...
          >
            <form
              ...
              onSubmit={handleSearchSubmit} // FIXED: Form Submit Handler Attached Here
            >
