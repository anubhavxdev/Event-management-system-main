...
Write-Host "🏷️  Creating GSSoC labels for $REPO..."
...
# ── QUALITY ──
gh label create "quality:clean"            --color "0e8a16" --description "GSSoC: Clean code — x1.2 multiplier" --repo $REPO --force
gh label create "quality:exceptional"      --color "006b75" --description "GSSoC: Exceptional quality — x1.5 multiplier" --repo $REPO --force
...
Write-Host ""
Write-Host "✅ All labels created for $REPO"
Write-Host "🚀 Now push your .github/ workflows and you're live!"
